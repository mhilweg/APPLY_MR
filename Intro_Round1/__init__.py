...
class Comprehension_check_1(MyBasePage):
    ...
    @staticmethod
    def vars_for_template(player: Player):
        # Get base context from MyBasePage (includes `task`, paths, etc.)
        ctx = MyBasePage.vars_for_template(player)
        task = ctx.get('task')

        if task == "Math-Memory":
            cq1 = {
                "main": "mathmemory_V2/Round1/hard/deck1/5_v_1_math_I_hard.png",
                "A":    "mathmemory_V2/Round1/hard/deck1/6_v_2_math_II_hard.png",
                "B":    "mathmemory_V2/Round1/hard/deck1/8_v_2_math_I_hard.png",
                "C":    "mathmemory_V2/Round1/hard/deck1/5_v_2_math_I_hard.png",  # correct -> C (3)
            }
            cq2 = {
                "main": "mathmemory_V2/Round1/easy/deck2/9_v_3_math_none_easy.png",
                "A":    "mathmemory_V2/Round1/easy/deck2/9_v_1_math_none_easy.png",  # correct -> A (1)
                "B":    "mathmemory_V2/Round1/easy/deck2/14_v_2_math_none_easy.png",
                "C":    "mathmemory_V2/Round1/easy/deck2/8_v_1_math_none_easy.png",
            }
        else:
            # Emotion Recognition Memory (adjust paths to your actual folder names)
            cq1 = {
                "main": "emotionrecognition/Round1/hard/deck3/Anger_11_emotion_happy_hard.png",
                "A":    "emotionrecognition/Round1/hard/deck3/Anger_1_word_sad_hard.png",
                "B":    "emotionrecognition/Round1/hard/deck3/Pain_1_word_happy_hard.png",
                "C":    "emotionrecognition/Round1/hard/deck3/Anger_1_word_happy_hard.png",  # correct -> C (3)
            }
            cq2 = {
                "main": "emotionrecognition/Round1/easy/deck3/Surprise_10_emotion_none_easy.png",
                "A":    "emotionrecognition/Round1/easy/deck3/Surprise_1_word_none_easy.png",  # correct -> A (1)
                "B":    "emotionrecognition/Round1/easy/deck3/Shame_1_word_none_easy.png",
                "C":    "emotionrecognition/Round1/easy/deck3/Fear_1_word_none_easy.png",
            }

        ctx.update({"cq1": cq1, "cq2": cq2})
        return ctx
...
class Comprehension_check_2(MyBasePage):
    ...
    @staticmethod
    def is_displayed(player: Player):
        return player.Allowed == 1 and player.cq_page_2 == 1
